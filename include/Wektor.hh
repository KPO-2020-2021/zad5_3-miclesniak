 ...
 * 
 * @param tmp tablica na podstawie której tworzymy wektor
 */

  Wektor(double tmp[Wymiar])
  {
  ...
  * 
  * @param Skl2 Vector z którym porównujemy
  ...
  */
  ...
  /**
   * @brief metoda Wyswietlająca Ilość utowrzonych obiektów 
   * 
   */
